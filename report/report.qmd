...
### Task 2 — Optional density compensation
As an optional control, we regenerate shells with more points on larger radii
(`--compensate ring` for 2D; `--compensate sphere` for 3D). This stabilizes the ε-graph within-shell connectivity
across the scan while leaving the spectral clustering and Gap pipeline unchanged.
